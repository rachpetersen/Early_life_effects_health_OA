...
#load data
```{r}
OA_data<-read.delim("Orang_Asli_data_file_for_Github.txt")
```
...
tmp<-OA_merged[,c(Body_Height,Body_Press,Blood_Bio,'sex')] %>%
  pivot_longer(!sex, names_to = "outcome", values_to = "value")
...
OA_merged$date_of_birth <- mdy(OA_merged$date_of_birth)
