...
No additional folder structure is required. Start a clean R session and restore the package environment by running the following:
...
Then restart R. Exact session details (R version, platform, and loaded package versions) are provided in the sessionInfo() output at the end of the R Markdown document.
---
##Data Requirements
